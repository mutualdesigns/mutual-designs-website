...
<meta charset="utf-8">
    ...
    <!--TITLE-->	
        <title>Vidtok: Group Video Chat</title>
    ...
    <!--GROUP APP CSS-->
    	<?php if($options['vsubscription'] == 'premium'){ ?> 
    		<link href="<?php echo VIDTOK_PLUGINFULLURL; ?>vidtok-package/css/group.premium.css" rel="stylesheet" />
        <?php }else if($options['vsubscription'] == 'advanced'){ ?>
        	<link href="<?php echo VIDTOK_PLUGINFULLURL; ?>vidtok-package/css/group.advanced.css" rel="stylesheet" />        
        <?php }else if($options['vsubscription'] == 'basic'){ ?>
        	<link href="<?php echo VIDTOK_PLUGINFULLURL; ?>vidtok-package/css/group.css" rel="stylesheet" />
        <?php } ?>  
   	...
   	<!--VIDTOK SHARE-->
       	<script type="text/javascript">
			 ...
			 jQuery(document).ready(function(e) {
			   ...
			   /*Authorize Vidtok*/ 
					jQuery.vidtok.authorize({ vApi : '<?php echo $options['vapi']; ?>', vArchive : '', vType : 'group', vPlatform : 'wordpress', oApi : '<?php echo $options['oapi']; ?>', oSession : '<?php echo $vidtok->opentok_session_id; ?>', oToken : '<?php echo $token; ?>' }); 
...
<body>
    	...
    	<?php if($options['vsubscription'] == 'premium'){ ?>
            <!--PREMIUM-->    
                <div class="vidtok-w">
                    ...
                    <!--VIDTOK SUBSCRIBER-->
                        <div class="vidtok-subsciber-h" id="vidtok-sub">	
                            <div id="vidtok-subscriber-1" class="vidtok-suscriber-small"><img src="<?php echo VIDTOK_PLUGINFULLURL; ?>vidtok-package/images/vidtok-logo-v-small.png" alt="Vitok Video Chat" /></div>
                            <div id="vidtok-subscriber-2" class="vidtok-suscriber-small"><img src="<?php echo VIDTOK_PLUGINFULLURL; ?>vidtok-package/images/vidtok-logo-v-small.png" alt="Vitok Video Chat" /></div>
                            <div id="vidtok-subscriber-3" class="vidtok-suscriber-small"><img src="<?php echo VIDTOK_PLUGINFULLURL; ?>vidtok-package/images/vidtok-logo-v-small.png" alt="Vitok Video Chat" /></div>
                            <div id="vidtok-subscriber-4" class="vidtok-suscriber-small"><img src="<?php echo VIDTOK_PLUGINFULLURL; ?>vidtok-package/images/vidtok-logo-v-small.png" alt="Vitok Video Chat" /></div>
                            <div id="vidtok-subscriber-5" class="vidtok-suscriber-small"><img src="<?php echo VIDTOK_PLUGINFULLURL; ?>vidtok-package/images/vidtok-logo-v-small.png" alt="Vitok Video Chat" /></div>
                            <div id="vidtok-subscriber-6" class="vidtok-suscriber-small"><img src="<?php echo VIDTOK_PLUGINFULLURL; ?>vidtok-package/images/vidtok-logo-v-small.png" alt="Vitok Video Chat" /></div>                    
                        </div>    
                    
                    <!--VIDTOK GROUP CONTROLS-->
    ...
    <!--VIDTOK SHARE LINK-->
		<div class="vidtok-share-w" id="vidtok-share-panel">
            ...
            <script>function tw_click() { u=location.href; t=document.title; window.open('http://twitter.com/intent/tweet?text=<?php echo urlencode('Join our Vidtok video chat! '.$currentUrl); ?>','sharer','toolbar=0,status=0,width=500,height=360');return false;}</script>
                    ...
                    <div class="vidtok-tool-panel-dialog">
                        ...
                        <!--SETTINGS-->
                            <div class="vidtok-tool-panel-dialog-c" id="vidtok-dialog-settings">
                            	<div class="vidtok-dialog-loading" id="vidtok-loading-network"><img src="<?php echo VIDTOK_PLUGINFULLURL; ?>vidtok-package/images/large-loader-cyan.gif" alt="" /><p>Loading Connected Devices...</p></div>
